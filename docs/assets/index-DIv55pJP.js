...
`].filter(uo).join(`
`)),o=uu(o),o=mf(o,t),o=_f(o,t),a=uu(a),a=mf(a,t),a=_f(a,t),o=gf(o),a=gf(a),t.isRawShaderMaterial!==!0&&(E=`#version 300 es
...
`)+`
`+p);const b=E+m+o,M=E+p+a,S=ff(i,i.VERTEX_SHADER,b),w=ff(i,i.FRAGMENT_SHADER,M);i.attachShader(g,S),i.attachShader(g,w),t.index0AttributeName!==void 0?i.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(g,0,"position"),i.linkProgram(g);function A(L){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(g)||"",B=i.getShaderInfoLog(S)||"",W=i.getShaderInfoLog(w)||"",H=N.trim(),k=B.trim(),O=W.trim();let $=!0,ie=!0;if(i.getProgramParameter(g,i.LINK_STATUS)===!1)if($=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,g,S,w);else{const R=pf(i,S,"vertex"),re=pf(i,w,"fragment");dt("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(g,i.VALIDATE_STATUS)+`
...
Program Info Log: `+H+`
`+R+`
`+re)}else H!==""?Xe("WebGLProgram: Program Info Log:",H):(k===""||O==="")&&(ie=!1);ie&&(L.diagnostics={runnable:$,programLog:H,vertexShader:{log:k,prefix:m},fragmentShader:{log:O,prefix:p}})}i.deleteShader(S),i.deleteShader(w),P=new ka(i,g),x=qv(i,g)}let P;this.getUniforms=function(){return P===void 0&&A(this),P};let x;this.getAttributes=function(){return x===void 0&&A(this),x};let y=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return y===!1&&(y=i.getProgramParameter(g,Fv)),y},this.destroy=function(){n.releaseStatesOfProgram(this),i.deleteProgram(g),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Ov++,this.cacheKey=e,this.usedTimes=1,this.program=g,this.vertexShader=S,this.fragmentShader=w,this}let lS=0;class cS{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,i=this._getShaderStage(t),s=this._getShaderStage(n),o=this._getShaderCacheForMaterial(e);return o.has(i)===!1&&(o.add(i),i.usedTimes++),o.has(s)===!1&&(o.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new uS(e),t.set(e,n)),n}}class uS{constructor(e){this.id=lS++,this.code=e,this.usedTimes=0}}function hS(r,e,t,n,i,s,o){const a=new wd,l=new cS,c=new Set,u=[],h=new Map,d=i.logarithmicDepthBuffer;let f=i.precision;const _={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return c.add(x),x===0?"uv":`uv${x}`}function m(x,y,L,N,B){const W=N.fog,H=B.geometry,k=x.isMeshStandardMaterial?N.environment:null,O=(x.isMeshStandardMaterial?t:e).get(x.envMap||k),$=O&&O.mapping===fl?O.image.height:null,ie=_[x.type];x.precision!==null&&(f=i.getMaxPrecision(x.precision),f!==x.precision&&Xe("WebGLProgram.getParameters:",x.precision,"not supported, using",f,"instead."));const R=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,re=R!==void 0?R.length:0;let Le=0;H.morphAttributes.position!==void 0&&(Le=1),H.morphAttributes.normal!==void 0&&(Le=2),H.morphAttributes.color!==void 0&&(Le=3);let Oe,He,Ye,K;if(ie){const _e=bi[ie];Oe=_e.vertexShader,He=_e.fragmentShader}else Oe=x.vertexShader,He=x.fragmentShader,l.update(x),Ye=l.getVertexShaderID(x),K=l.getFragmentShaderID(x);const J=r.getRenderTarget(),fe=r.state.buffers.depth.getReversed(),Re=B.isInstancedMesh===!0,Se=B.isBatchedMesh===!0,ke=!!x.map,at=!!x.matcap,Te=!!O,Be=!!x.aoMap,$e=!!x.lightMap,Ne=!!x.bumpMap,G=!!x.normalMap,I=!!x.displacementMap,mt=!!x.emissiveMap,Je=!!x.metalnessMap,ze=!!x.roughnessMap,Me=x.anisotropy>0,C=x.clearcoat>0,v=x.dispersion>0,U=x.iridescence>0,Z=x.sheen>0,j=x.transmission>0,Y=Me&&!!x.anisotropyMap,ve=C&&!!x.clearcoatMap,se=C&&!!x.clearcoatNormalMap,be=C&&!!x.clearcoatRoughnessMap,Ee=U&&!!x.iridescenceMap,ne=U&&!!x.iridescenceThicknessMap,oe=Z&&!!x.sheenColorMap,ye=Z&&!!x.sheenRoughnessMap,Ae=!!x.specularMap,ae=!!x.specularColorMap,Ge=!!x.specularIntensityMap,D=j&&!!x.transmissionMap,ue=j&&!!x.thicknessMap,te=!!x.gradientMap,he=!!x.alphaMap,ee=x.alphaTest>0,Q=!!x.alphaHash,ce=!!x.extensions;let Ie=Di;x.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(Ie=r.toneMapping);const ct={shaderID:ie,shaderType:x.type,shaderName:x.name,vertexShader:Oe,fragmentShader:He,defines:x.defines,customVertexShaderID:Ye,customFragmentShaderID:K,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:f,batching:Se,batchingColor:Se&&B._colorsTexture!==null,instancing:Re,instancingColor:Re&&B.instanceColor!==null,instancingMorph:Re&&B.morphTexture!==null,outputColorSpace:J===null?r.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:zs,alphaToCoverage:!!x.alphaToCoverage,map:ke,matcap:at,envMap:Te,envMapMode:Te&&O.mapping,envMapCubeUVHeight:$,aoMap:Be,lightMap:$e,bumpMap:Ne,normalMap:G,displacementMap:I,emissiveMap:mt,normalMapObjectSpace:G&&x.normalMapType===qm,normalMapTangentSpace:G&&x.normalMapType===Xm,metalnessMap:Je,roughnessMap:ze,anisotropy:Me,anisotropyMap:Y,clearcoat:C,clearcoatMap:ve,clearcoatNormalMap:se,clearcoatRoughnessMap:be,dispersion:v,iridescence:U,iridescenceMap:Ee,iridescenceThicknessMap:ne,sheen:Z,sheenColorMap:oe,sheenRoughnessMap:ye,specularMap:Ae,specularColorMap:ae,specularIntensityMap:Ge,transmission:j,transmissionMap:D,thicknessMap:ue,gradientMap:te,opaque:x.transparent===!1&&x.blending===Cs&&x.alphaToCoverage===!1,alphaMap:he,alphaTest:ee,alphaHash:Q,combine:x.combine,mapUv:ke&&g(x.map.channel),aoMapUv:Be&&g(x.aoMap.channel),lightMapUv:$e&&g(x.lightMap.channel),bumpMapUv:Ne&&g(x.bumpMap.channel),normalMapUv:G&&g(x.normalMap.channel),displacementMapUv:I&&g(x.displacementMap.channel),emissiveMapUv:mt&&g(x.emissiveMap.channel),metalnessMapUv:Je&&g(x.metalnessMap.channel),roughnessMapUv:ze&&g(x.roughnessMap.channel),anisotropyMapUv:Y&&g(x.anisotropyMap.channel),clearcoatMapUv:ve&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:se&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:be&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:Ee&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:ne&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:oe&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:ye&&g(x.sheenRoughnessMap.channel),specularMapUv:Ae&&g(x.specularMap.channel),specularColorMapUv:ae&&g(x.specularColorMap.channel),specularIntensityMapUv:Ge&&g(x.specularIntensityMap.channel),transmissionMapUv:D&&g(x.transmissionMap.channel),thicknessMapUv:ue&&g(x.thicknessMap.channel),alphaMapUv:he&&g(x.alphaMap.channel),vertexTangents:!!H.attributes.tangent&&(G||Me),vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,pointsUvs:B.isPoints===!0&&!!H.attributes.uv&&(ke||he),fog:!!W,useFog:x.fog===!0,fogExp2:!!W&&W.isFogExp2,flatShading:x.flatShading===!0&&x.wireframe===!1,sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:fe,skinning:B.isSkinnedMesh===!0,morphTargets:H.morphAttributes.position!==void 0,morphNormals:H.morphAttributes.normal!==void 0,morphColors:H.morphAttributes.color!==void 0,morphTargetsCount:re,morphTextureStride:Le,numDirLights:y.directional.length,numPointLights:y.point.length,numSpotLights:y.spot.length,numSpotLightMaps:y.spotLightMap.length,numRectAreaLights:y.rectArea.length,numHemiLights:y.hemi.length,numDirLightShadows:y.directionalShadowMap.length,numPointLightShadows:y.pointShadowMap.length,numSpotLightShadows:y.spotShadowMap.length,numSpotLightShadowsWithMaps:y.numSpotLightShadowsWithMaps,numLightProbes:y.numLightProbes,numClippingPlanes:o.numPlanes,numClipIntersection:o.numIntersection,dithering:x.dithering,shadowMapEnabled:r.shadowMap.enabled&&L.length>0,shadowMapType:r.shadowMap.type,toneMapping:Ie,decodeVideoTexture:ke&&x.map.isVideoTexture===!0&&lt.getTransfer(x.map.colorSpace)===St,decodeVideoTextureEmissive:mt&&x.emissiveMap.isVideoTexture===!0&&lt.getTransfer(x.emissiveMap.colorSpace)===St,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===Wi,flipSided:x.side===In,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:ce&&x.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(ce&&x.extensions.multiDraw===!0||Se)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return ct.vertexUv1s=c.has(1),ct.vertexUv2s=c.has(2),ct.vertexUv3s=c.has(3),c.clear(),ct}function p(x){const y=[];if(x.shaderID?y.push(x.shaderID):(y.push(x.customVertexShaderID),y.push(x.customFragmentShaderID)),x.defines!==void 0)for(const L in x.defines)y.push(L),y.push(x.defines[L]);return x.isRawShaderMaterial===!1&&(E(y,x),b(y,x),y.push(r.outputColorSpace)),y.push(x.customProgramCacheKey),y.join()}function E(x,y){x.push(y.precision),x.push(y.outputColorSpace),x.push(y.envMapMode),x.push(y.envMapCubeUVHeight),x.push(y.mapUv),x.push(y.alphaMapUv),x.push(y.lightMapUv),x.push(y.aoMapUv),x.push(y.bumpMapUv),x.push(y.normalMapUv),x.push(y.displacementMapUv),x.push(y.emissiveMapUv),x.push(y.metalnessMapUv),x.push(y.roughnessMapUv),x.push(y.anisotropyMapUv),x.push(y.clearcoatMapUv),x.push(y.clearcoatNormalMapUv),x.push(y.clearcoatRoughnessMapUv),x.push(y.iridescenceMapUv),x.push(y.iridescenceThicknessMapUv),x.push(y.sheenColorMapUv),x.push(y.sheenRoughnessMapUv),x.push(y.specularMapUv),x.push(y.specularColorMapUv),x.push(y.specularIntensityMapUv),x.push(y.transmissionMapUv),x.push(y.thicknessMapUv),x.push(y.combine),x.push(y.fogExp2),x.push(y.sizeAttenuation),x.push(y.morphTargetsCount),x.push(y.morphAttributeCount),x.push(y.numDirLights),x.push(y.numPointLights),x.push(y.numSpotLights),x.push(y.numSpotLightMaps),x.push(y.numHemiLights),x.push(y.numRectAreaLights),x.push(y.numDirLightShadows),x.push(y.numPointLightShadows),x.push(y.numSpotLightShadows),x.push(y.numSpotLightShadowsWithMaps),x.push(y.numLightProbes),x.push(y.shadowMapType),x.push(y.toneMapping),x.push(y.numClippingPlanes),x.push(y.numClipIntersection),x.push(y.depthPacking)}function b(x,y){a.disableAll(),y.instancing&&a.enable(0),y.instancingColor&&a.enable(1),y.instancingMorph&&a.enable(2),y.matcap&&a.enable(3),y.envMap&&a.enable(4),y.normalMapObjectSpace&&a.enable(5),y.normalMapTangentSpace&&a.enable(6),y.clearcoat&&a.enable(7),y.iridescence&&a.enable(8),y.alphaTest&&a.enable(9),y.vertexColors&&a.enable(10),y.vertexAlphas&&a.enable(11),y.vertexUv1s&&a.enable(12),y.vertexUv2s&&a.enable(13),y.vertexUv3s&&a.enable(14),y.vertexTangents&&a.enable(15),y.anisotropy&&a.enable(16),y.alphaHash&&a.enable(17),y.batching&&a.enable(18),y.dispersion&&a.enable(19),y.batchingColor&&a.enable(20),y.gradientMap&&a.enable(21),x.push(a.mask),a.disableAll(),y.fog&&a.enable(0),y.useFog&&a.enable(1),y.flatShading&&a.enable(2),y.logarithmicDepthBuffer&&a.enable(3),y.reversedDepthBuffer&&a.enable(4),y.skinning&&a.enable(5),y.morphTargets&&a.enable(6),y.morphNormals&&a.enable(7),y.morphColors&&a.enable(8),y.premultipliedAlpha&&a.enable(9),y.shadowMapEnabled&&a.enable(10),y.doubleSided&&a.enable(11),y.flipSided&&a.enable(12),y.useDepthPacking&&a.enable(13),y.dithering&&a.enable(14),y.transmission&&a.enable(15),y.sheen&&a.enable(16),y.opaque&&a.enable(17),y.pointsUvs&&a.enable(18),y.decodeVideoTexture&&a.enable(19),y.decodeVideoTextureEmissive&&a.enable(20),y.alphaToCoverage&&a.enable(21),x.push(a.mask)}function M(x){const y=_[x.type];let L;if(y){const N=bi[y];L=S_.clone(N.uniforms)}else L=x.uniforms;return L}function S(x,y){let L=h.get(y);return L!==void 0?++L.usedTimes:(L=new aS(r,y,x,s),u.push(L),h.set(y,L)),L}function w(x){if(--x.usedTimes===0){const y=u.indexOf(x);u[y]=u[u.length-1],u.pop(),h.delete(x.cacheKey),x.destroy()}}function A(x){l.remove(x)}function P(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:M,acquireProgram:S,releaseProgram:w,releaseShaderCache:A,programs:u,dispose:P}}function fS(){let r=new WeakMap;function e(o){return r.has(o)}function t(o){let a=r.get(o);return a===void 0&&(a={},r.set(o,a)),a}function n(o){r.delete(o)}function i(o,a,l){r.get(o)[a]=l}function s(){r=new WeakMap}return{has:e,get:t,remove:n,update:i,dispose:s}}function dS(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.material.id!==e.material.id?r.material.id-e.material.id:r.z!==e.z?r.z-e.z:r.id-e.id}function vf(r,e){return r.groupOrder!==e.groupOrder?r.groupOrder-e.groupOrder:r.renderOrder!==e.renderOrder?r.renderOrder-e.renderOrder:r.z!==e.z?e.z-r.z:r.id-e.id}function Sf(){const r=[];let e=0;const t=[],n=[],i=[];function s(){e=0,t.length=0,n.length=0,i.length=0}function o(h,d,f,_,g,m){let p=r[e];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:_,renderOrder:h.renderOrder,z:g,group:m},r[e]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=_,p.renderOrder=h.renderOrder,p.z=g,p.group=m),e++,p}function a(h,d,f,_,g,m){const p=o(h,d,f,_,g,m);f.transmission>0?n.push(p):f.transparent===!0?i.push(p):t.push(p)}function l(h,d,f,_,g,m){const p=o(h,d,f,_,g,m);f.transmission>0?n.unshift(p):f.transparent===!0?i.unshift(p):t.unshift(p)}function c(h,d){t.length>1&&t.sort(h||dS),n.length>1&&n.sort(d||vf),i.length>1&&i.sort(d||vf)}function u(){for(let h=e,d=r.length;h<d;h++){const f=r[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:i,init:s,push:a,unshift:l,finish:u,sort:c}}function pS(){let r=new WeakMap;function e(n,i){const s=r.get(n);let o;return s===void 0?(o=new Sf,r.set(n,[o])):i>=s.length?(o=new Sf,s.push(o)):o=s[i],o}function t(){r=new WeakMap}return{get:e,dispose:t}}function mS(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new V,color:new pt};break;case"SpotLight":t={position:new V,direction:new V,color:new pt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new V,color:new pt,distance:0,decay:0};break;case"HemisphereLight":t={direction:new V,skyColor:new pt,groundColor:new pt};break;case"RectAreaLight":t={color:new pt,position:new V,halfWidth:new V,halfHeight:new V};break}return r[e.id]=t,t}}}function _S(){const r={};return{get:function(e){if(r[e.id]!==void 0)return r[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new gt};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new gt};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new gt,shadowCameraNear:1,shadowCameraFar:1e3};break}return r[e.id]=t,t}}}let gS=0;function xS(r,e){return(e.castShadow?2:0)-(r.castShadow?2:0)+(e.map?1:0)-(r.map?1:0)}function vS(r){const e=new mS,t=_S(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new V);const i=new V,s=new Dt,o=new Dt;function a(c){let u=0,h=0,d=0;for(let x=0;x<9;x++)n.probe[x].set(0,0,0);let f=0,_=0,g=0,m=0,p=0,E=0,b=0,M=0,S=0,w=0,A=0;c.sort(xS);for(let x=0,y=c.length;x<y;x++){const L=c[x],N=L.color,B=L.intensity,W=L.distance;let H=null;if(L.shadow&&L.shadow.map&&(L.shadow.map.texture.format===Bs?H=L.shadow.map.texture:H=L.shadow.map.depthTexture||L.shadow.map.texture),L.isAmbientLight)u+=N.r*B,h+=N.g*B,d+=N.b*B;else if(L.isLightProbe){for(let k=0;k<9;k++)n.probe[k].addScaledVector(L.sh.coefficients[k],B);A++}else if(L.isDirectionalLight){const k=e.get(L);if(k.color.copy(L.color).multiplyScalar(L.intensity),L.castShadow){const O=L.shadow,$=t.get(L);$.shadowIntensity=O.intensity,$.shadowBias=O.bias,$.shadowNormalBias=O.normalBias,$.shadowRadius=O.radius,$.shadowMapSize=O.mapSize,n.directionalShadow[f]=$,n.directionalShadowMap[f]=H,n.directionalShadowMatrix[f]=L.shadow.matrix,E++}n.directional[f]=k,f++}else if(L.isSpotLight){const k=e.get(L);k.position.setFromMatrixPosition(L.matrixWorld),k.color.copy(N).multiplyScalar(B),k.distance=W,k.coneCos=Math.cos(L.angle),k.penumbraCos=Math.cos(L.angle*(1-L.penumbra)),k.decay=L.decay,n.spot[g]=k;const O=L.shadow;if(L.map&&(n.spotLightMap[S]=L.map,S++,O.updateMatrices(L),L.castShadow&&w++),n.spotLightMatrix[g]=O.matrix,L.castShadow){const $=t.get(L);$.shadowIntensity=O.intensity,$.shadowBias=O.bias,$.shadowNormalBias=O.normalBias,$.shadowRadius=O.radius,$.shadowMapSize=O.mapSize,n.spotShadow[g]=$,n.spotShadowMap[g]=H,M++}g++}else if(L.isRectAreaLight){const k=e.get(L);k.color.copy(N).multiplyScalar(B),k.halfWidth.set(L.width*.5,0,0),k.halfHeight.set(0,L.height*.5,0),n.rectArea[m]=k,m++}else if(L.isPointLight){const k=e.get(L);if(k.color.copy(L.color).multiplyScalar(L.intensity),k.distance=L.distance,k.decay=L.decay,L.castShadow){const O=L.shadow,$=t.get(L);$.shadowIntensity=O.intensity,$.shadowBias=O.bias,$.shadowNormalBias=O.normalBias,$.shadowRadius=O.radius,$.shadowMapSize=O.mapSize,$.shadowCameraNear=O.camera.near,$.shadowCameraFar=O.camera.far,n.pointShadow[_]=$,n.pointShadowMap[_]=H,n.pointShadowMatrix[_]=L.shadow.matrix,b++}n.point[_]=k,_++}else if(L.isHemisphereLight){const k=e.get(L);k.skyColor.copy(L.color).multiplyScalar(B),k.groundColor.copy(L.groundColor).multiplyScalar(B),n.hemi[p]=k,p++}}m>0&&(r.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=me.LTC_FLOAT_1,n.rectAreaLTC2=me.LTC_FLOAT_2):(n.rectAreaLTC1=me.LTC_HALF_1,n.rectAreaLTC2=me.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const P=n.hash;(P.directionalLength!==f||P.pointLength!==_||P.spotLength!==g||P.rectAreaLength!==m||P.hemiLength!==p||P.numDirectionalShadows!==E||P.numPointShadows!==b||P.numSpotShadows!==M||P.numSpotMaps!==S||P.numLightProbes!==A)&&(n.directional.length=f,n.spot.length=g,n.rectArea.length=m,n.point.length=_,n.hemi.length=p,n.directionalShadow.length=E,n.directionalShadowMap.length=E,n.pointShadow.length=b,n.pointShadowMap.length=b,n.spotShadow.length=M,n.spotShadowMap.length=M,n.directionalShadowMatrix.length=E,n.pointShadowMatrix.length=b,n.spotLightMatrix.length=M+S-w,n.spotLightMap.length=S,n.numSpotLightShadowsWithMaps=w,n.numLightProbes=A,P.directionalLength=f,P.pointLength=_,P.spotLength=g,P.rectAreaLength=m,P.hemiLength=p,P.numDirectionalShadows=E,P.numPointShadows=b,P.numSpotShadows=M,P.numSpotMaps=S,P.numLightProbes=A,n.version=gS++)}function l(c,u){let h=0,d=0,f=0,_=0,g=0;const m=u.matrixWorldInverse;for(let p=0,E=c.length;p<E;p++){const b=c[p];if(b.isDirectionalLight){const M=n.directional[h];M.direction.setFromMatrixPosition(b.matrixWorld),i.setFromMatrixPosition(b.target.matrixWorld),M.direction.sub(i),M.direction.transformDirection(m),h++}else if(b.isSpotLight){const M=n.spot[f];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),M.direction.setFromMatrixPosition(b.matrixWorld),i.setFromMatrixPosition(b.target.matrixWorld),M.direction.sub(i),M.direction.transformDirection(m),f++}else if(b.isRectAreaLight){const M=n.rectArea[_];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),o.identity(),s.copy(b.matrixWorld),s.premultiply(m),o.extractRotation(s),M.halfWidth.set(b.width*.5,0,0),M.halfHeight.set(0,b.height*.5,0),M.halfWidth.applyMatrix4(o),M.halfHeight.applyMatrix4(o),_++}else if(b.isPointLight){const M=n.point[d];M.position.setFromMatrixPosition(b.matrixWorld),M.position.applyMatrix4(m),d++}else if(b.isHemisphereLight){const M=n.hemi[g];M.direction.setFromMatrixPosition(b.matrixWorld),M.direction.transformDirection(m),g++}}}return{setup:a,setupView:l,state:n}}function Mf(r){const e=new vS(r),t=[],n=[];function i(u){c.camera=u,t.length=0,n.length=0}function s(u){t.push(u)}function o(u){n.push(u)}function a(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:i,state:c,setupLights:a,setupLightsView:l,pushLight:s,pushShadow:o}}function SS(r){let e=new WeakMap;function t(i,s=0){const o=e.get(i);let a;return o===void 0?(a=new Mf(r),e.set(i,[a])):s>=o.length?(a=new Mf(r),o.push(a)):a=o[s],a}function n(){e=new WeakMap}return{get:t,dispose:n}}const MS=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;class LS{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Od(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new Mi({vertexShader:PS,fragmentShader:DS,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new er(new dl(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class IS extends $s{constructor(e,t){super();const n=this;let i=null,s=1,o=null,a="local-floor",l=1,c=null,u=null,h=null,d=null,f=null,_=null;const g=typeof XRWebGLBinding<"u",m=new LS,p={},E=t.getContextAttributes();let b=null,M=null;const S=[],w=[],A=new gt;let P=null;const x=new Yn;x.viewport=new Ot;const y=new Yn;y.viewport=new Ot;const L=[x,y],N=new H_;let B=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let J=S[K];return J===void 0&&(J=new Wl,S[K]=J),J.getTargetRaySpace()},this.getControllerGrip=function(K){let J=S[K];return J===void 0&&(J=new Wl,S[K]=J),J.getGripSpace()},this.getHand=function(K){let J=S[K];return J===void 0&&(J=new Wl,S[K]=J),J.getHandSpace()};function H(K){const J=w.indexOf(K.inputSource);if(J===-1)return;const fe=S[J];fe!==void 0&&(fe.update(K.inputSource,K.frame,c||o),fe.dispatchEvent({type:K.type,data:K.inputSource}))}function k(){i.removeEventListener("select",H),i.removeEventListener("selectstart",H),i.removeEventListener("selectend",H),i.removeEventListener("squeeze",H),i.removeEventListener("squeezestart",H),i.removeEventListener("squeezeend",H),i.removeEventListener("end",k),i.removeEventListener("inputsourceschange",O);for(let K=0;K<S.length;K++){const J=w[K];J!==null&&(w[K]=null,S[K].disconnect(J))}B=null,W=null,m.reset();for(const K in p)delete p[K];e.setRenderTarget(b),f=null,d=null,h=null,i=null,M=null,Ye.stop(),n.isPresenting=!1,e.setPixelRatio(P),e.setSize(A.width,A.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&Xe("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){a=K,n.isPresenting===!0&&Xe("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return c||o},this.setReferenceSpace=function(K){c=K},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return h===null&&g&&(h=new XRWebGLBinding(i,t)),h},this.getFrame=function(){return _},this.getSession=function(){return i},this.setSession=async function(K){if(i=K,i!==null){if(b=e.getRenderTarget(),i.addEventListener("select",H),i.addEventListener("selectstart",H),i.addEventListener("selectend",H),i.addEventListener("squeeze",H),i.addEventListener("squeezestart",H),i.addEventListener("squeezeend",H),i.addEventListener("end",k),i.addEventListener("inputsourceschange",O),E.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(A),g&&"createProjectionLayer"in XRWebGLBinding.prototype){let fe=null,Re=null,Se=null;E.depth&&(Se=E.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,fe=E.stencil?Hr:Ji,Re=E.stencil?Io:Ni);const ke={colorFormat:t.RGBA8,depthFormat:Se,scaleFactor:s};h=this.getBinding(),d=h.createProjectionLayer(ke),i.updateRenderState({layers:[d]}),e.setPixelRatio(1),e.setSize(d.textureWidth,d.textureHeight,!1),M=new Li(d.textureWidth,d.textureHeight,{format:vi,type:Kn,depthTexture:new Uo(d.textureWidth,d.textureHeight,Re,void 0,void 0,void 0,void 0,void 0,void 0,fe),stencilBuffer:E.stencil,colorSpace:e.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1,resolveStencilBuffer:d.ignoreDepthValues===!1})}else{const fe={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:s};f=new XRWebGLLayer(i,t,fe),i.updateRenderState({baseLayer:f}),e.setPixelRatio(1),e.setSize(f.framebufferWidth,f.framebufferHeight,!1),M=new Li(f.framebufferWidth,f.framebufferHeight,{format:vi,type:Kn,colorSpace:e.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),c=null,o=await i.requestReferenceSpace(a),Ye.setContext(i),Ye.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function O(K){for(let J=0;J<K.removed.length;J++){const fe=K.removed[J],Re=w.indexOf(fe);Re>=0&&(w[Re]=null,S[Re].disconnect(fe))}for(let J=0;J<K.added.length;J++){const fe=K.added[J];let Re=w.indexOf(fe);if(Re===-1){for(let ke=0;ke<S.length;ke++)if(ke>=w.length){w.push(fe),Re=ke;break}else if(w[ke]===null){w[ke]=fe,Re=ke;break}if(Re===-1)break}const Se=S[Re];Se&&Se.connect(fe)}}const $=new V,ie=new V;function R(K,J,fe){$.setFromMatrixPosition(J.matrixWorld),ie.setFromMatrixPosition(fe.matrixWorld);const Re=$.distanceTo(ie),Se=J.projectionMatrix.elements,ke=fe.projectionMatrix.elements,at=Se[14]/(Se[10]-1),Te=Se[14]/(Se[10]+1),Be=(Se[9]+1)/Se[5],$e=(Se[9]-1)/Se[5],Ne=(Se[8]-1)/Se[0],G=(ke[8]+1)/ke[0],I=at*Ne,mt=at*G,Je=Re/(-Ne+G),ze=Je*-Ne;if(J.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(ze),K.translateZ(Je),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Se[10]===-1)K.projectionMatrix.copy(J.projectionMatrix),K.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const Me=at+Je,C=Te+Je,v=I-ze,U=mt+(Re-ze),Z=Be*Te/C*Me,j=$e*Te/C*Me;K.projectionMatrix.makePerspective(v,U,Z,j,Me,C),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function re(K,J){J===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(J.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(i===null)return;let J=K.near,fe=K.far;m.texture!==null&&(m.depthNear>0&&(J=m.depthNear),m.depthFar>0&&(fe=m.depthFar)),N.near=y.near=x.near=J,N.far=y.far=x.far=fe,(B!==N.near||W!==N.far)&&(i.updateRenderState({depthNear:N.near,depthFar:N.far}),B=N.near,W=N.far),N.layers.mask=K.layers.mask|6,x.layers.mask=N.layers.mask&3,y.layers.mask=N.layers.mask&5;const Re=K.parent,Se=N.cameras;re(N,Re);for(let ke=0;ke<Se.length;ke++)re(Se[ke],Re);Se.length===2?R(N,x,y):N.projectionMatrix.copy(x.projectionMatrix),Le(K,N,Re)};function Le(K,J,fe){fe===null?K.matrix.copy(J.matrixWorld):(K.matrix.copy(fe.matrixWorld),K.matrix.invert(),K.matrix.multiply(J.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(J.projectionMatrix),K.projectionMatrixInverse.copy(J.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=au*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(d===null&&f===null))return l},this.setFoveation=function(K){l=K,d!==null&&(d.fixedFoveation=K),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(K){return p[K]};let Oe=null;function He(K,J){if(u=J.getViewerPose(c||o),_=J,u!==null){const fe=u.views;f!==null&&(e.setRenderTargetFramebuffer(M,f.framebuffer),e.setRenderTarget(M));let Re=!1;fe.length!==N.cameras.length&&(N.cameras.length=0,Re=!0);for(let Te=0;Te<fe.length;Te++){const Be=fe[Te];let $e=null;if(f!==null)$e=f.getViewport(Be);else{const G=h.getViewSubImage(d,Be);$e=G.viewport,Te===0&&(e.setRenderTargetTextures(M,G.colorTexture,G.depthStencilTexture),e.setRenderTarget(M))}let Ne=L[Te];Ne===void 0&&(Ne=new Yn,Ne.layers.enable(Te),Ne.viewport=new Ot,L[Te]=Ne),Ne.matrix.fromArray(Be.transform.matrix),Ne.matrix.decompose(Ne.position,Ne.quaternion,Ne.scale),Ne.projectionMatrix.fromArray(Be.projectionMatrix),Ne.projectionMatrixInverse.copy(Ne.projectionMatrix).invert(),Ne.viewport.set($e.x,$e.y,$e.width,$e.height),Te===0&&(N.matrix.copy(Ne.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Re===!0&&N.cameras.push(Ne)}const Se=i.enabledFeatures;if(Se&&Se.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&g){h=n.getBinding();const Te=h.getDepthInformation(fe[0]);Te&&Te.isValid&&Te.texture&&m.init(Te,i.renderState)}if(Se&&Se.includes("camera-access")&&g){e.state.unbindTexture(),h=n.getBinding();for(let Te=0;Te<fe.length;Te++){const Be=fe[Te].camera;if(Be){let $e=p[Be];$e||($e=new Od,p[Be]=$e);const Ne=h.getCameraImage(Be);$e.sourceTexture=Ne}}}}for(let fe=0;fe<S.length;fe++){const Re=w[fe],Se=S[fe];Re!==null&&Se!==void 0&&Se.update(Re,J,c||o)}Oe&&Oe(K,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),_=null}const Ye=new kd;Ye.setAnimationLoop(He),this.setAnimationLoop=function(K){Oe=K},this.dispose=function(){}}}const Ir=new Qi,NS=new Dt;function US(r,e){function t(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Ld(r)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,E,b,M){p.isMeshBasicMaterial||p.isMeshLambertMaterial?s(m,p):p.isMeshToonMaterial?(s(m,p),h(m,p)):p.isMeshPhongMaterial?(s(m,p),u(m,p)):p.isMeshStandardMaterial?(s(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,M)):p.isMeshMatcapMaterial?(s(m,p),_(m,p)):p.isMeshDepthMaterial?s(m,p):p.isMeshDistanceMaterial?(s(m,p),g(m,p)):p.isMeshNormalMaterial?s(m,p):p.isLineBasicMaterial?(o(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?l(m,p,E,b):p.isSpriteMaterial?c(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function s(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,t(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===In&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,t(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===In&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,t(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,t(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,t(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const E=e.get(p),b=E.envMap,M=E.envMapRotation;b&&(m.envMap.value=b,Ir.copy(M),Ir.x*=-1,Ir.y*=-1,Ir.z*=-1,b.isCubeTexture&&b.isRenderTargetTexture===!1&&(Ir.y*=-1,Ir.z*=-1),m.envMapRotation.value.setFromMatrix4(NS.makeRotationFromEuler(Ir)),m.flipEnvMap.value=b.isCubeTexture&&b.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap&&(m.lightMap.value=p.lightMap,m.lightMapIntensity.value=p.lightMapIntensity,t(p.lightMap,m.lightMapTransform)),p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,t(p.aoMap,m.aoMapTransform))}function o(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function l(m,p,E,b){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*E,m.scale.value=b*.5,p.map&&(m.map.value=p.map,t(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function c(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,t(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,t(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function u(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function h(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,t(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,t(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,E){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,t(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,t(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,t(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,t(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,t(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===In&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,t(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,t(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,t(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,t(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,t(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,t(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,t(p.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,p){p.matcap&&(m.matcap.value=p.matcap)}function g(m,p){const E=e.get(p).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function FS(r,e,t,n){let i={},s={},o=[];const a=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function l(E,b){const M=b.program;n.uniformBlockBinding(E,M)}function c(E,b){let M=i[E.id];M===void 0&&(_(E),M=u(E),i[E.id]=M,E.addEventListener("dispose",m));const S=b.program;n.updateUBOMapping(E,S);const w=e.render.frame;s[E.id]!==w&&(d(E),s[E.id]=w)}function u(E){const b=h();E.__bindingPointIndex=b;const M=r.createBuffer(),S=E.__size,w=E.usage;return r.bindBuffer(r.UNIFORM_BUFFER,M),r.bufferData(r.UNIFORM_BUFFER,S,w),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,b,M),M}function h(){for(let E=0;E<a;E++)if(o.indexOf(E)===-1)return o.push(E),E;return dt("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(E){const b=i[E.id],M=E.uniforms,S=E.__cache;r.bindBuffer(r.UNIFORM_BUFFER,b);for(let w=0,A=M.length;w<A;w++){const P=Array.isArray(M[w])?M[w]:[M[w]];for(let x=0,y=P.length;x<y;x++){const L=P[x];if(f(L,w,x,S)===!0){const N=L.__offset,B=Array.isArray(L.value)?L.value:[L.value];let W=0;for(let H=0;H<B.length;H++){const k=B[H],O=g(k);typeof k=="number"||typeof k=="boolean"?(L.__data[0]=k,r.bufferSubData(r.UNIFORM_BUFFER,N+W,L.__data)):k.isMatrix3?(L.__data[0]=k.elements[0],L.__data[1]=k.elements[1],L.__data[2]=k.elements[2],L.__data[3]=0,L.__data[4]=k.elements[3],L.__data[5]=k.elements[4],L.__data[6]=k.elements[5],L.__data[7]=0,L.__data[8]=k.elements[6],L.__data[9]=k.elements[7],L.__data[10]=k.elements[8],L.__data[11]=0):(k.toArray(L.__data,W),W+=O.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,N,L.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function f(E,b,M,S){const w=E.value,A=b+"_"+M;if(S[A]===void 0)return typeof w=="number"||typeof w=="boolean"?S[A]=w:S[A]=w.clone(),!0;{const P=S[A];if(typeof w=="number"||typeof w=="boolean"){if(P!==w)return S[A]=w,!0}else if(P.equals(w)===!1)return P.copy(w),!0}return!1}function _(E){const b=E.uniforms;let M=0;const S=16;for(let A=0,P=b.length;A<P;A++){const x=Array.isArray(b[A])?b[A]:[b[A]];for(let y=0,L=x.length;y<L;y++){const N=x[y],B=Array.isArray(N.value)?N.value:[N.value];for(let W=0,H=B.length;W<H;W++){const k=B[W],O=g(k),$=M%S,ie=$%O.boundary,R=$+ie;M+=ie,R!==0&&S-R<O.storage&&(M+=S-R),N.__data=new Float32Array(O.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=M,M+=O.storage}}}const w=M%S;return w>0&&(M+=S-w),E.__size=M,E.__cache={},this}function g(E){const b={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(b.boundary=4,b.storage=4):E.isVector2?(b.boundary=8,b.storage=8):E.isVector3||E.isColor?(b.boundary=16,b.storage=12):E.isVector4?(b.boundary=16,b.storage=16):E.isMatrix3?(b.boundary=48,b.storage=48):E.isMatrix4?(b.boundary=64,b.storage=64):E.isTexture?Xe("WebGLRenderer: Texture samplers can not be part of an uniforms group."):Xe("WebGLRenderer: Unsupported uniform value type.",E),b}function m(E){const b=E.target;b.removeEventListener("dispose",m);const M=o.indexOf(b.__bindingPointIndex);o.splice(M,1),r.deleteBuffer(i[b.id]),delete i[b.id],delete s[b.id]}function p(){for(const E in i)r.deleteBuffer(i[E]);o=[],i={},s={}}return{bind:l,update:c,dispose:p}}const OS=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let yi=null;function BS(){return yi===null&&(yi=new A_(OS,16,16,Bs,ji),yi.name="DFG_LUT",yi.minFilter=mn,yi.magFilter=mn,yi.wrapS=qi,yi.wrapT=qi,yi.generateMipmaps=!1,yi.needsUpdate=!0),yi}class zS{constructor(e={}){const{canvas:t=Qm(),context:n=null,depth:i=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:c=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:d=!1,outputBufferType:f=Kn}=e;this.isWebGLRenderer=!0;let _;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=n.getContextAttributes().alpha}else _=o;const g=f,m=new Set([Vu,ku,zu]),p=new Set([Kn,Ni,Lo,Io,Ou,Bu]),E=new Uint32Array(4),b=new Int32Array(4);let M=null,S=null;const w=[],A=[];let P=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Di,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const x=this;let y=!1;this._outputColorSpace=ai;let L=0,N=0,B=null,W=-1,H=null;const k=new Ot,O=new Ot;let $=null;const ie=new pt(0);let R=0,re=t.width,Le=t.height,Oe=1,He=null,Ye=null;const K=new Ot(0,0,re,Le),J=new Ot(0,0,re,Le);let fe=!1;const Re=new qu;let Se=!1,ke=!1;const at=new Dt,Te=new V,Be=new Ot,$e={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ne=!1;function G(){return B===null?Oe:1}let I=n;function mt(T,F){return t.getContext(T,F)}try{const T={alpha:!0,depth:i,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:c,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Uu}`),t.addEventListener("webglcontextlost",Ie,!1),t.addEventListener("webglcontextrestored",ct,!1),t.addEventListener("webglcontextcreationerror",_e,!1),I===null){const F="webgl2";if(I=mt(F,T),I===null)throw mt(F)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(T){throw dt("WebGLRenderer: "+T.message),T}let Je,ze,Me,C,v,U,Z,j,Y,ve,se,be,Ee,ne,oe,ye,Ae,ae,Ge,D,ue,te,he,ee;function Q(){Je=new Bx(I),Je.init(),te=new RS(I,Je),ze=new Rx(I,Je,e,te),Me=new wS(I,Je),ze.reversedDepthBuffer&&d&&Me.buffers.depth.setReversed(!0),C=new Vx(I),v=new fS,U=new CS(I,Je,Me,v,ze,te,C),Z=new Dx(x),j=new Ox(x),Y=new X_(I),he=new wx(I,Y),ve=new zx(I,Y,C,he),se=new Hx(I,ve,Y,C),Ge=new Gx(I,ze,U),ye=new Px(v),be=new hS(x,Z,j,Je,ze,he,ye),Ee=new US(x,v),ne=new pS,oe=new SS(Je),ae=new Ax(x,Z,j,Me,se,_,l),Ae=new bS(x,se,ze),ee=new FS(I,C,ze,Me),D=new Cx(I,Je,C),ue=new kx(I,Je,C),C.programs=be.programs,x.capabilities=ze,x.extensions=Je,x.properties=v,x.renderLists=ne,x.shadowMap=Ae,x.state=Me,x.info=C}Q(),g!==Kn&&(P=new Xx(g,t.width,t.height,i,s));const ce=new IS(x,I);this.xr=ce,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const T=Je.get("WEBGL_lose_context");T&&T.loseContext()},this.forceContextRestore=function(){const T=Je.get("WEBGL_lose_context");T&&T.restoreContext()},this.getPixelRatio=function(){return Oe},this.setPixelRatio=function(T){T!==void 0&&(Oe=T,this.setSize(re,Le,!1))},this.getSize=function(T){return T.set(re,Le)},this.setSize=function(T,F,q=!0){if(ce.isPresenting){Xe("WebGLRenderer: Can't change size while VR device is presenting.");return}re=T,Le=F,t.width=Math.floor(T*Oe),t.height=Math.floor(F*Oe),q===!0&&(t.style.width=T+"px",t.style.height=F+"px"),P!==null&&P.setSize(t.width,t.height),this.setViewport(0,0,T,F)},this.getDrawingBufferSize=function(T){return T.set(re*Oe,Le*Oe).floor()},this.setDrawingBufferSize=function(T,F,q){re=T,Le=F,Oe=q,t.width=Math.floor(T*q),t.height=Math.floor(F*q),this.setViewport(0,0,T,F)},this.setEffects=function(T){if(g===Kn){console.error("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(T){for(let F=0;F<T.length;F++)if(T[F].isOutputPass===!0){console.warn("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}P.setEffects(T||[])},this.getCurrentViewport=function(T){return T.copy(k)},this.getViewport=function(T){return T.copy(K)},this.setViewport=function(T,F,q,X){T.isVector4?K.set(T.x,T.y,T.z,T.w):K.set(T,F,q,X),Me.viewport(k.copy(K).multiplyScalar(Oe).round())},this.getScissor=function(T){return T.copy(J)},this.setScissor=function(T,F,q,X){T.isVector4?J.set(T.x,T.y,T.z,T.w):J.set(T,F,q,X),Me.scissor(O.copy(J).multiplyScalar(Oe).round())},this.getScissorTest=function(){return fe},this.setScissorTest=function(T){Me.setScissorTest(fe=T)},this.setOpaqueSort=function(T){He=T},this.setTransparentSort=function(T){Ye=T},this.getClearColor=function(T){return T.copy(ae.getClearColor())},this.setClearColor=function(){ae.setClearColor(...arguments)},this.getClearAlpha=function(){return ae.getClearAlpha()},this.setClearAlpha=function(){ae.setClearAlpha(...arguments)},this.clear=function(T=!0,F=!0,q=!0){let X=0;if(T){let z=!1;if(B!==null){const le=B.texture.format;z=m.has(le)}if(z){const le=B.texture.type,ge=p.has(le),de=ae.getClearColor(),xe=ae.getClearAlpha(),Pe=de.r,Ve=de.g,Ue=de.b;ge?(E[0]=Pe,E[1]=Ve,E[2]=Ue,E[3]=xe,I.clearBufferuiv(I.COLOR,0,E)):(b[0]=Pe,b[1]=Ve,b[2]=Ue,b[3]=xe,I.clearBufferiv(I.COLOR,0,b))}else X|=I.COLOR_BUFFER_BIT}F&&(X|=I.DEPTH_BUFFER_BIT),q&&(X|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),I.clear(X)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Ie,!1),t.removeEventListener("webglcontextrestored",ct,!1),t.removeEventListener("webglcontextcreationerror",_e,!1),ae.dispose(),ne.dispose(),oe.dispose(),v.dispose(),Z.dispose(),j.dispose(),se.dispose(),he.dispose(),ee.dispose(),be.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",zt),ce.removeEventListener("sessionend",tt),xt.stop()};function Ie(T){T.preventDefault(),wh("WebGLRenderer: Context Lost."),y=!0}function ct(){wh("WebGLRenderer: Context Restored."),y=!1;const T=C.autoReset,F=Ae.enabled,q=Ae.autoUpdate,X=Ae.needsUpdate,z=Ae.type;Q(),C.autoReset=T,Ae.enabled=F,Ae.autoUpdate=q,Ae.needsUpdate=X,Ae.type=z}function _e(T){dt("WebGLRenderer: A WebGL context could not be created. Reason: ",T.statusMessage)}function Ce(T){const F=T.target;F.removeEventListener("dispose",Ce),Ke(F)}function Ke(T){pe(T),v.remove(T)}function pe(T){const F=v.get(T).programs;F!==void 0&&(F.forEach(function(q){be.releaseProgram(q)}),T.isShaderMaterial&&be.releaseShaderCache(T))}this.renderBufferDirect=function(T,F,q,X,z,le){F===null&&(F=$e);const ge=z.isMesh&&z.matrixWorld.determinant()<0,de=qt(T,F,q,X,z);Me.setMaterial(X,ge);let xe=q.index,Pe=1;if(X.wireframe===!0){if(xe=ve.getWireframeAttribute(q),xe===void 0)return;Pe=2}const Ve=q.drawRange,Ue=q.attributes.position;let nt=Ve.start*Pe,yt=(Ve.start+Ve.count)*Pe;le!==null&&(nt=Math.max(nt,le.start*Pe),yt=Math.min(yt,(le.start+le.count)*Pe)),xe!==null?(nt=Math.max(nt,0),yt=Math.min(yt,xe.count)):Ue!=null&&(nt=Math.max(nt,0),yt=Math.min(yt,Ue.count));const Ut=yt-nt;if(Ut<0||Ut===1/0)return;he.setup(z,X,de,q,xe);let Ft,Tt=D;if(xe!==null&&(Ft=Y.get(xe),Tt=ue,Tt.setIndex(Ft)),z.isMesh)X.wireframe===!0?(Me.setLineWidth(X.wireframeLinewidth*G()),Tt.setMode(I.LINES)):Tt.setMode(I.TRIANGLES);else if(z.isLine){let Fe=X.linewidth;Fe===void 0&&(Fe=1),Me.setLineWidth(Fe*G()),z.isLineSegments?Tt.setMode(I.LINES):z.isLineLoop?Tt.setMode(I.LINE_LOOP):Tt.setMode(I.LINE_STRIP)}else z.isPoints?Tt.setMode(I.POINTS):z.isSprite&&Tt.setMode(I.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)No("WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Tt.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(Je.get("WEBGL_multi_draw"))Tt.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Fe=z._multiDrawStarts,vt=z._multiDrawCounts,ht=z._multiDrawCount,kn=xe?Y.get(xe).bytesPerElement:1,ss=v.get(X).currentProgram.getUniforms();for(let Vn=0;Vn<ht;Vn++)ss.setValue(I,"_gl_DrawID",Vn),Tt.render(Fe[Vn]/kn,vt[Vn])}else if(z.isInstancedMesh)Tt.renderInstances(nt,Ut,z.count);else if(q.isInstancedBufferGeometry){const Fe=q._maxInstanceCount!==void 0?q._maxInstanceCount:1/0,vt=Math.min(q.instanceCount,Fe);Tt.renderInstances(nt,Ut,vt)}else Tt.render(nt,Ut)};function We(T,F,q){T.transparent===!0&&T.side===Wi&&T.forceSinglePass===!1?(T.side=In,T.needsUpdate=!0,Mt(T,F,q),T.side=Mr,T.needsUpdate=!0,Mt(T,F,q),T.side=Wi):Mt(T,F,q)}this.compile=function(T,F,q=null){q===null&&(q=T),S=oe.get(q),S.init(F),A.push(S),q.traverseVisible(function(z){z.isLight&&z.layers.test(F.layers)&&(S.pushLight(z),z.castShadow&&S.pushShadow(z))}),T!==q&&T.traverseVisible(function(z){z.isLight&&z.layers.test(F.layers)&&(S.pushLight(z),z.castShadow&&S.pushShadow(z))}),S.setupLights();const X=new Set;return T.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const le=z.material;if(le)if(Array.isArray(le))for(let ge=0;ge<le.length;ge++){const de=le[ge];We(de,q,z),X.add(de)}else We(le,q,z),X.add(le)}),S=A.pop(),X},this.compileAsync=function(T,F,q=null){const X=this.compile(T,F,q);return new Promise(z=>{function le(){if(X.forEach(function(ge){v.get(ge).currentProgram.isReady()&&X.delete(ge)}),X.size===0){z(T);return}setTimeout(le,10)}Je.get("KHR_parallel_shader_compile")!==null?le():setTimeout(le,10)})};let De=null;function qe(T){De&&De(T)}function zt(){xt.stop()}function tt(){xt.start()}const xt=new kd;xt.setAnimationLoop(qe),typeof self<"u"&&xt.setContext(self),this.setAnimationLoop=function(T){De=T,ce.setAnimationLoop(T),T===null?xt.stop():xt.start()},ce.addEventListener("sessionstart",zt),ce.addEventListener("sessionend",tt),this.render=function(T,F){if(F!==void 0&&F.isCamera!==!0){dt("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(y===!0)return;const q=ce.enabled===!0&&ce.isPresenting===!0,X=P!==null&&(B===null||q)&&P.begin(x,B);if(T.matrixWorldAutoUpdate===!0&&T.updateMatrixWorld(),F.parent===null&&F.matrixWorldAutoUpdate===!0&&F.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(P===null||P.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(F),F=ce.getCamera()),T.isScene===!0&&T.onBeforeRender(x,T,F,B),S=oe.get(T,A.length),S.init(F),A.push(S),at.multiplyMatrices(F.projectionMatrix,F.matrixWorldInverse),Re.setFromProjectionMatrix(at,Ci,F.reversedDepth),ke=this.localClippingEnabled,Se=ye.init(this.clippingPlanes,ke),M=ne.get(T,w.length),M.init(),w.push(M),ce.enabled===!0&&ce.isPresenting===!0){const ge=x.xr.getDepthSensingMesh();ge!==null&&Gt(ge,F,-1/0,x.sortObjects)}Gt(T,F,0,x.sortObjects),M.finish(),x.sortObjects===!0&&M.sort(He,Ye),Ne=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,Ne&&ae.addToRenderList(M,T),this.info.render.frame++,Se===!0&&ye.beginShadows();const z=S.state.shadowsArray;if(Ae.render(z,T,F),Se===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset(),(X&&P.hasRenderPass())===!1){const ge=M.opaque,de=M.transmissive;if(S.setupLights(),F.isArrayCamera){const xe=F.cameras;if(de.length>0)for(let Pe=0,Ve=xe.length;Pe<Ve;Pe++){const Ue=xe[Pe];Et(ge,de,T,Ue)}Ne&&ae.render(T);for(let Pe=0,Ve=xe.length;Pe<Ve;Pe++){const Ue=xe[Pe];Rt(M,T,Ue,Ue.viewport)}}else de.length>0&&Et(ge,de,T,F),Ne&&ae.render(T),Rt(M,T,F)}B!==null&&N===0&&(U.updateMultisampleRenderTarget(B),U.updateRenderTargetMipmap(B)),X&&P.end(x),T.isScene===!0&&T.onAfterRender(x,T,F),he.resetDefaultState(),W=-1,H=null,A.pop(),A.length>0?(S=A[A.length-1],Se===!0&&ye.setGlobalState(x.clippingPlanes,S.state.camera)):S=null,w.pop(),w.length>0?M=w[w.length-1]:M=null};function Gt(T,F,q,X){if(T.visible===!1)return;if(T.layers.test(F.layers)){if(T.isGroup)q=T.renderOrder;else if(T.isLOD)T.autoUpdate===!0&&T.update(F);else if(T.isLight)S.pushLight(T),T.castShadow&&S.pushShadow(T);else if(T.isSprite){if(!T.frustumCulled||Re.intersectsSprite(T)){X&&Be.setFromMatrixPosition(T.matrixWorld).applyMatrix4(at);const ge=se.update(T),de=T.material;de.visible&&M.push(T,ge,de,q,Be.z,null)}}else if((T.isMesh||T.isLine||T.isPoints)&&(!T.frustumCulled||Re.intersectsObject(T))){const ge=se.update(T),de=T.material;if(X&&(T.boundingSphere!==void 0?(T.boundingSphere===null&&T.computeBoundingSphere(),Be.copy(T.boundingSphere.center)):(ge.boundingSphere===null&&ge.computeBoundingSphere(),Be.copy(ge.boundingSphere.center)),Be.applyMatrix4(T.matrixWorld).applyMatrix4(at)),Array.isArray(de)){const xe=ge.groups;for(let Pe=0,Ve=xe.length;Pe<Ve;Pe++){const Ue=xe[Pe],nt=de[Ue.materialIndex];nt&&nt.visible&&M.push(T,ge,nt,q,Be.z,Ue)}}else de.visible&&M.push(T,ge,de,q,Be.z,null)}}const le=T.children;for(let ge=0,de=le.length;ge<de;ge++)Gt(le[ge],F,q,X)}function Rt(T,F,q,X){const{opaque:z,transmissive:le,transparent:ge}=T;S.setupLightsView(q),Se===!0&&ye.setGlobalState(x.clippingPlanes,q),X&&Me.viewport(k.copy(X)),z.length>0&&ut(z,F,q),le.length>0&&ut(le,F,q),ge.length>0&&ut(ge,F,q),Me.buffers.depth.setTest(!0),Me.buffers.depth.setMask(!0),Me.buffers.color.setMask(!0),Me.setPolygonOffset(!1)}function Et(T,F,q,X){if((q.isScene===!0?q.overrideMaterial:null)!==null)return;if(S.state.transmissionRenderTarget[X.id]===void 0){const nt=Je.has("EXT_color_buffer_half_float")||Je.has("EXT_color_buffer_float");S.state.transmissionRenderTarget[X.id]=new Li(1,1,{generateMipmaps:!0,type:nt?ji:Kn,minFilter:Gr,samples:ze.samples,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:lt.workingColorSpace})}const le=S.state.transmissionRenderTarget[X.id],ge=X.viewport||k;le.setSize(ge.z*x.transmissionResolutionScale,ge.w*x.transmissionResolutionScale);const de=x.getRenderTarget(),xe=x.getActiveCubeFace(),Pe=x.getActiveMipmapLevel();x.setRenderTarget(le),x.getClearColor(ie),R=x.getClearAlpha(),R<1&&x.setClearColor(16777215,.5),x.clear(),Ne&&ae.render(q);const Ve=x.toneMapping;x.toneMapping=Di;const Ue=X.viewport;if(X.viewport!==void 0&&(X.viewport=void 0),S.setupLightsView(X),Se===!0&&ye.setGlobalState(x.clippingPlanes,X),ut(T,q,X),U.updateMultisampleRenderTarget(le),U.updateRenderTargetMipmap(le),Je.has("WEBGL_multisampled_render_to_texture")===!1){let nt=!1;for(let yt=0,Ut=F.length;yt<Ut;yt++){const Ft=F[yt],{object:Tt,geometry:Fe,material:vt,group:ht}=Ft;if(vt.side===Wi&&Tt.layers.test(X.layers)){const kn=vt.side;vt.side=In,vt.needsUpdate=!0,Cn(Tt,q,X,Fe,vt,ht),vt.side=kn,vt.needsUpdate=!0,nt=!0}}nt===!0&&(U.updateMultisampleRenderTarget(le),U.updateRenderTargetMipmap(le))}x.setRenderTarget(de,xe,Pe),x.setClearColor(ie,R),Ue!==void 0&&(X.viewport=Ue),x.toneMapping=Ve}function ut(T,F,q){const X=F.isScene===!0?F.overrideMaterial:null;for(let z=0,le=T.length;z<le;z++){const ge=T[z],{object:de,geometry:xe,group:Pe}=ge;let Ve=ge.material;Ve.allowOverride===!0&&X!==null&&(Ve=X),de.layers.test(q.layers)&&Cn(de,F,q,xe,Ve,Pe)}}function Cn(T,F,q,X,z,le){T.onBeforeRender(x,F,q,X,z,le),T.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,T.matrixWorld),T.normalMatrix.getNormalMatrix(T.modelViewMatrix),z.onBeforeRender(x,F,q,X,T,le),z.transparent===!0&&z.side===Wi&&z.forceSinglePass===!1?(z.side=In,z.needsUpdate=!0,x.renderBufferDirect(q,F,X,z,T,le),z.side=Mr,z.needsUpdate=!0,x.renderBufferDirect(q,F,X,z,T,le),z.side=Wi):x.renderBufferDirect(q,F,X,z,T,le),T.onAfterRender(x,F,q,X,z,le)}function Mt(T,F,q){F.isScene!==!0&&(F=$e);const X=v.get(T),z=S.state.lights,le=S.state.shadowsArray,ge=z.state.version,de=be.getParameters(T,z.state,le,F,q),xe=be.getProgramCacheKey(de);let Pe=X.programs;X.environment=T.isMeshStandardMaterial?F.environment:null,X.fog=F.fog,X.envMap=(T.isMeshStandardMaterial?j:Z).get(T.envMap||X.environment),X.envMapRotation=X.environment!==null&&T.envMap===null?F.environmentRotation:T.envMapRotation,Pe===void 0&&(T.addEventListener("dispose",Ce),Pe=new Map,X.programs=Pe);let Ve=Pe.get(xe);if(Ve!==void 0){if(X.currentProgram===Ve&&X.lightsStateVersion===ge)return zn(T,de),Ve}else de.uniforms=be.getUniforms(T),T.onBeforeCompile(de,x),Ve=be.acquireProgram(de,xe),Pe.set(xe,Ve),X.uniforms=de.uniforms;const Ue=X.uniforms;return(!T.isShaderMaterial&&!T.isRawShaderMaterial||T.clipping===!0)&&(Ue.clippingPlanes=ye.uniform),zn(T,de),X.needsLights=Jt(T),X.lightsStateVersion=ge,X.needsLights&&(Ue.ambientLightColor.value=z.state.ambient,Ue.lightProbe.value=z.state.probe,Ue.directionalLights.value=z.state.directional,Ue.directionalLightShadows.value=z.state.directionalShadow,Ue.spotLights.value=z.state.spot,Ue.spotLightShadows.value=z.state.spotShadow,Ue.rectAreaLights.value=z.state.rectArea,Ue.ltc_1.value=z.state.rectAreaLTC1,Ue.ltc_2.value=z.state.rectAreaLTC2,Ue.pointLights.value=z.state.point,Ue.pointLightShadows.value=z.state.pointShadow,Ue.hemisphereLights.value=z.state.hemi,Ue.directionalShadowMap.value=z.state.directionalShadowMap,Ue.directionalShadowMatrix.value=z.state.directionalShadowMatrix,Ue.spotShadowMap.value=z.state.spotShadowMap,Ue.spotLightMatrix.value=z.state.spotLightMatrix,Ue.spotLightMap.value=z.state.spotLightMap,Ue.pointShadowMap.value=z.state.pointShadowMap,Ue.pointShadowMatrix.value=z.state.pointShadowMatrix),X.currentProgram=Ve,X.uniformsList=null,Ve}function ln(T){if(T.uniformsList===null){const F=T.currentProgram.getUniforms();T.uniformsList=ka.seqWithValue(F.seq,T.uniforms)}return T.uniformsList}function zn(T,F){const q=v.get(T);q.outputColorSpace=F.outputColorSpace,q.batching=F.batching,q.batchingColor=F.batchingColor,q.instancing=F.instancing,q.instancingColor=F.instancingColor,q.instancingMorph=F.instancingMorph,q.skinning=F.skinning,q.morphTargets=F.morphTargets,q.morphNormals=F.morphNormals,q.morphColors=F.morphColors,q.morphTargetsCount=F.morphTargetsCount,q.numClippingPlanes=F.numClippingPlanes,q.numIntersection=F.numClipIntersection,q.vertexAlphas=F.vertexAlphas,q.vertexTangents=F.vertexTangents,q.toneMapping=F.toneMapping}function qt(T,F,q,X,z){F.isScene!==!0&&(F=$e),U.resetTextureUnits();const le=F.fog,ge=X.isMeshStandardMaterial?F.environment:null,de=B===null?x.outputColorSpace:B.isXRRenderTarget===!0?B.texture.colorSpace:zs,xe=(X.isMeshStandardMaterial?j:Z).get(X.envMap||ge),Pe=X.vertexColors===!0&&!!q.attributes.color&&q.attributes.color.itemSize===4,Ve=!!q.attributes.tangent&&(!!X.normalMap||X.anisotropy>0),Ue=!!q.morphAttributes.position,nt=!!q.morphAttributes.normal,yt=!!q.morphAttributes.color;let Ut=Di;X.toneMapped&&(B===null||B.isXRRenderTarget===!0)&&(Ut=x.toneMapping);const Ft=q.morphAttributes.position||q.morphAttributes.normal||q.morphAttributes.color,Tt=Ft!==void 0?Ft.length:0,Fe=v.get(X),vt=S.state.lights;if(Se===!0&&(ke===!0||T!==H)){const vn=T===H&&X.id===W;ye.setState(X,T,vn)}let ht=!1;X.version===Fe.__version?(Fe.needsLights&&Fe.lightsStateVersion!==vt.state.version||Fe.outputColorSpace!==de||z.isBatchedMesh&&Fe.batching===!1||!z.isBatchedMesh&&Fe.batching===!0||z.isBatchedMesh&&Fe.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&Fe.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&Fe.instancing===!1||!z.isInstancedMesh&&Fe.instancing===!0||z.isSkinnedMesh&&Fe.skinning===!1||!z.isSkinnedMesh&&Fe.skinning===!0||z.isInstancedMesh&&Fe.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&Fe.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&Fe.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&Fe.instancingMorph===!1&&z.morphTexture!==null||Fe.envMap!==xe||X.fog===!0&&Fe.fog!==le||Fe.numClippingPlanes!==void 0&&(Fe.numClippingPlanes!==ye.numPlanes||Fe.numIntersection!==ye.numIntersection)||Fe.vertexAlphas!==Pe||Fe.vertexTangents!==Ve||Fe.morphTargets!==Ue||Fe.morphNormals!==nt||Fe.morphColors!==yt||Fe.toneMapping!==Ut||Fe.morphTargetsCount!==Tt)&&(ht=!0):(ht=!0,Fe.__version=X.version);let kn=Fe.currentProgram;ht===!0&&(kn=Mt(X,F,z));let ss=!1,Vn=!1,js=!1;const wt=kn.getUniforms(),Rn=Fe.uniforms;if(Me.useProgram(kn.program)&&(ss=!0,Vn=!0,js=!0),X.id!==W&&(W=X.id,Vn=!0),ss||H!==T){Me.buffers.depth.getReversed()&&T.reversedDepth!==!0&&(T._reversedDepth=!0,T.updateProjectionMatrix()),wt.setValue(I,"projectionMatrix",T.projectionMatrix),wt.setValue(I,"viewMatrix",T.matrixWorldInverse);const Pn=wt.map.cameraPosition;Pn!==void 0&&Pn.setValue(I,Te.setFromMatrixPosition(T.matrixWorld)),ze.logarithmicDepthBuffer&&wt.setValue(I,"logDepthBufFC",2/(Math.log(T.far+1)/Math.LN2)),(X.isMeshPhongMaterial||X.isMeshToonMaterial||X.isMeshLambertMaterial||X.isMeshBasicMaterial||X.isMeshStandardMaterial||X.isShaderMaterial)&&wt.setValue(I,"isOrthographic",T.isOrthographicCamera===!0),H!==T&&(H=T,Vn=!0,js=!0)}if(Fe.needsLights&&(vt.state.directionalShadowMap.length>0&&wt.setValue(I,"directionalShadowMap",vt.state.directionalShadowMap,U),vt.state.spotShadowMap.length>0&&wt.setValue(I,"spotShadowMap",vt.state.spotShadowMap,U),vt.state.pointShadowMap.length>0&&wt.setValue(I,"pointShadowMap",vt.state.pointShadowMap,U)),z.isSkinnedMesh){wt.setOptional(I,z,"bindMatrix"),wt.setOptional(I,z,"bindMatrixInverse");const vn=z.skeleton;vn&&(vn.boneTexture===null&&vn.computeBoneTexture(),wt.setValue(I,"boneTexture",vn.boneTexture,U))}z.isBatchedMesh&&(wt.setOptional(I,z,"batchingTexture"),wt.setValue(I,"batchingTexture",z._matricesTexture,U),wt.setOptional(I,z,"batchingIdTexture"),wt.setValue(I,"batchingIdTexture",z._indirectTexture,U),wt.setOptional(I,z,"batchingColorTexture"),z._colorsTexture!==null&&wt.setValue(I,"batchingColorTexture",z._colorsTexture,U));const ri=q.morphAttributes;if((ri.position!==void 0||ri.normal!==void 0||ri.color!==void 0)&&Ge.update(z,q,kn),(Vn||Fe.receiveShadow!==z.receiveShadow)&&(Fe.receiveShadow=z.receiveShadow,wt.setValue(I,"receiveShadow",z.receiveShadow)),X.isMeshGouraudMaterial&&X.envMap!==null&&(Rn.envMap.value=xe,Rn.flipEnvMap.value=xe.isCubeTexture&&xe.isRenderTargetTexture===!1?-1:1),X.isMeshStandardMaterial&&X.envMap===null&&F.environment!==null&&(Rn.envMapIntensity.value=F.environmentIntensity),Rn.dfgLUT!==void 0&&(Rn.dfgLUT.value=BS()),Vn&&(wt.setValue(I,"toneMappingExposure",x.toneMappingExposure),Fe.needsLights&&Yt(Rn,js),le&&X.fog===!0&&Ee.refreshFogUniforms(Rn,le),Ee.refreshMaterialUniforms(Rn,X,Oe,Le,S.state.transmissionRenderTarget[T.id]),ka.upload(I,ln(Fe),Rn,U)),X.isShaderMaterial&&X.uniformsNeedUpdate===!0&&(ka.upload(I,ln(Fe),Rn,U),X.uniformsNeedUpdate=!1),X.isSpriteMaterial&&wt.setValue(I,"center",z.center),wt.setValue(I,"modelViewMatrix",z.modelViewMatrix),wt.setValue(I,"normalMatrix",z.normalMatrix),wt.setValue(I,"modelMatrix",z.matrixWorld),X.isShaderMaterial||X.isRawShaderMaterial){const vn=X.uniformsGroups;for(let Pn=0,Sl=vn.length;Pn<Sl;Pn++){const wr=vn[Pn];ee.update(wr,kn),ee.bind(wr,kn)}}return kn}function Yt(T,F){T.ambientLightColor.needsUpdate=F,T.lightProbe.needsUpdate=F,T.directionalLights.needsUpdate=F,T.directionalLightShadows.needsUpdate=F,T.pointLights.needsUpdate=F,T.pointLightShadows.needsUpdate=F,T.spotLights.needsUpdate=F,T.spotLightShadows.needsUpdate=F,T.rectAreaLights.needsUpdate=F,T.hemisphereLights.needsUpdate=F}function Jt(T){return T.isMeshLambertMaterial||T.isMeshToonMaterial||T.isMeshPhongMaterial||T.isMeshStandardMaterial||T.isShadowMaterial||T.isShaderMaterial&&T.lights===!0}this.getActiveCubeFace=function(){return L},this.getActiveMipmapLevel=function(){return N},this.getRenderTarget=function(){return B},this.setRenderTargetTextures=function(T,F,q){const X=v.get(T);X.__autoAllocateDepthBuffer=T.resolveDepthBuffer===!1,X.__autoAllocateDepthBuffer===!1&&(X.__useRenderToTexture=!1),v.get(T.texture).__webglTexture=F,v.get(T.depthTexture).__webglTexture=X.__autoAllocateDepthBuffer?void 0:q,X.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(T,F){const q=v.get(T);q.__webglFramebuffer=F,q.__useDefaultFramebuffer=F===void 0};const Fi=I.createFramebuffer();this.setRenderTarget=function(T,F=0,q=0){B=T,L=F,N=q;let X=null,z=!1,le=!1;if(T){const de=v.get(T);if(de.__useDefaultFramebuffer!==void 0){Me.bindFramebuffer(I.FRAMEBUFFER,de.__webglFramebuffer),k.copy(T.viewport),O.copy(T.scissor),$=T.scissorTest,Me.viewport(k),Me.scissor(O),Me.setScissorTest($),W=-1;return}else if(de.__webglFramebuffer===void 0)U.setupRenderTarget(T);else if(de.__hasExternalTextures)U.rebindTextures(T,v.get(T.texture).__webglTexture,v.get(T.depthTexture).__webglTexture);else if(T.depthBuffer){const Ve=T.depthTexture;if(de.__boundDepthTexture!==Ve){if(Ve!==null&&v.has(Ve)&&(T.width!==Ve.image.width||T.height!==Ve.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");U.setupDepthRenderbuffer(T)}}const xe=T.texture;(xe.isData3DTexture||xe.isDataArrayTexture||xe.isCompressedArrayTexture)&&(le=!0);const Pe=v.get(T).__webglFramebuffer;T.isWebGLCubeRenderTarget?(Array.isArray(Pe[F])?X=Pe[F][q]:X=Pe[F],z=!0):T.samples>0&&U.useMultisampledRTT(T)===!1?X=v.get(T).__webglMultisampledFramebuffer:Array.isArray(Pe)?X=Pe[q]:X=Pe,k.copy(T.viewport),O.copy(T.scissor),$=T.scissorTest}else k.copy(K).multiplyScalar(Oe).floor(),O.copy(J).multiplyScalar(Oe).floor(),$=fe;if(q!==0&&(X=Fi),Me.bindFramebuffer(I.FRAMEBUFFER,X)&&Me.drawBuffers(T,X),Me.viewport(k),Me.scissor(O),Me.setScissorTest($),z){const de=v.get(T.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+F,de.__webglTexture,q)}else if(le){const de=F;for(let xe=0;xe<T.textures.length;xe++){const Pe=v.get(T.textures[xe]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+xe,Pe.__webglTexture,q,de)}}else if(T!==null&&q!==0){const de=v.get(T.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,de.__webglTexture,q)}W=-1},this.readRenderTargetPixels=function(T,F,q,X,z,le,ge,de=0){if(!(T&&T.isWebGLRenderTarget)){dt("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let xe=v.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ge!==void 0&&(xe=xe[ge]),xe){Me.bindFramebuffer(I.FRAMEBUFFER,xe);try{const Pe=T.textures[de],Ve=Pe.format,Ue=Pe.type;if(!ze.textureFormatReadable(Ve)){dt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ze.textureTypeReadable(Ue)){dt("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}F>=0&&F<=T.width-X&&q>=0&&q<=T.height-z&&(T.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+de),I.readPixels(F,q,X,z,te.convert(Ve),te.convert(Ue),le))}finally{const Pe=B!==null?v.get(B).__webglFramebuffer:null;Me.bindFramebuffer(I.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(T,F,q,X,z,le,ge,de=0){if(!(T&&T.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let xe=v.get(T).__webglFramebuffer;if(T.isWebGLCubeRenderTarget&&ge!==void 0&&(xe=xe[ge]),xe)if(F>=0&&F<=T.width-X&&q>=0&&q<=T.height-z){Me.bindFramebuffer(I.FRAMEBUFFER,xe);const Pe=T.textures[de],Ve=Pe.format,Ue=Pe.type;if(!ze.textureFormatReadable(Ve))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ze.textureTypeReadable(Ue))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const nt=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,nt),I.bufferData(I.PIXEL_PACK_BUFFER,le.byteLength,I.STREAM_READ),T.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+de),I.readPixels(F,q,X,z,te.convert(Ve),te.convert(Ue),0);const yt=B!==null?v.get(B).__webglFramebuffer:null;Me.bindFramebuffer(I.FRAMEBUFFER,yt);const Ut=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),await e_(I,Ut,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,nt),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,le),I.deleteBuffer(nt),I.deleteSync(Ut),le}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(T,F=null,q=0){const X=Math.pow(2,-q),z=Math.floor(T.image.width*X),le=Math.floor(T.image.height*X),ge=F!==null?F.x:0,de=F!==null?F.y:0;U.setTexture2D(T,0),I.copyTexSubImage2D(I.TEXTURE_2D,q,0,0,ge,de,z,le),Me.unbindTexture()};const rs=I.createFramebuffer(),Qt=I.createFramebuffer();this.copyTextureToTexture=function(T,F,q=null,X=null,z=0,le=null){le===null&&(z!==0?(No("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),le=z,z=0):le=0);let ge,de,xe,Pe,Ve,Ue,nt,yt,Ut;const Ft=T.isCompressedTexture?T.mipmaps[le]:T.image;if(q!==null)ge=q.max.x-q.min.x,de=q.max.y-q.min.y,xe=q.isBox3?q.max.z-q.min.z:1,Pe=q.min.x,Ve=q.min.y,Ue=q.isBox3?q.min.z:0;else{const ri=Math.pow(2,-z);ge=Math.floor(Ft.width*ri),de=Math.floor(Ft.height*ri),T.isDataArrayTexture?xe=Ft.depth:T.isData3DTexture?xe=Math.floor(Ft.depth*ri):xe=1,Pe=0,Ve=0,Ue=0}X!==null?(nt=X.x,yt=X.y,Ut=X.z):(nt=0,yt=0,Ut=0);const Tt=te.convert(F.format),Fe=te.convert(F.type);let vt;F.isData3DTexture?(U.setTexture3D(F,0),vt=I.TEXTURE_3D):F.isDataArrayTexture||F.isCompressedArrayTexture?(U.setTexture2DArray(F,0),vt=I.TEXTURE_2D_ARRAY):(U.setTexture2D(F,0),vt=I.TEXTURE_2D),I.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,F.flipY),I.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,F.premultiplyAlpha),I.pixelStorei(I.UNPACK_ALIGNMENT,F.unpackAlignment);const ht=I.getParameter(I.UNPACK_ROW_LENGTH),kn=I.getParameter(I.UNPACK_IMAGE_HEIGHT),ss=I.getParameter(I.UNPACK_SKIP_PIXELS),Vn=I.getParameter(I.UNPACK_SKIP_ROWS),js=I.getParameter(I.UNPACK_SKIP_IMAGES);I.pixelStorei(I.UNPACK_ROW_LENGTH,Ft.width),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,Ft.height),I.pixelStorei(I.UNPACK_SKIP_PIXELS,Pe),I.pixelStorei(I.UNPACK_SKIP_ROWS,Ve),I.pixelStorei(I.UNPACK_SKIP_IMAGES,Ue);const wt=T.isDataArrayTexture||T.isData3DTexture,Rn=F.isDataArrayTexture||F.isData3DTexture;if(T.isDepthTexture){const ri=v.get(T),vn=v.get(F),Pn=v.get(ri.__renderTarget),Sl=v.get(vn.__renderTarget);Me.bindFramebuffer(I.READ_FRAMEBUFFER,Pn.__webglFramebuffer),Me.bindFramebuffer(I.DRAW_FRAMEBUFFER,Sl.__webglFramebuffer);for(let wr=0;wr<xe;wr++)wt&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,v.get(T).__webglTexture,z,Ue+wr),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,v.get(F).__webglTexture,le,Ut+wr)),I.blitFramebuffer(Pe,Ve,ge,de,nt,yt,ge,de,I.DEPTH_BUFFER_BIT,I.NEAREST);Me.bindFramebuffer(I.READ_FRAMEBUFFER,null),Me.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(z!==0||T.isRenderTargetTexture||v.has(T)){const ri=v.get(T),vn=v.get(F);Me.bindFramebuffer(I.READ_FRAMEBUFFER,rs),Me.bindFramebuffer(I.DRAW_FRAMEBUFFER,Qt);for(let Pn=0;Pn<xe;Pn++)wt?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,ri.__webglTexture,z,Ue+Pn):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,ri.__webglTexture,z),Rn?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,vn.__webglTexture,le,Ut+Pn):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,vn.__webglTexture,le),z!==0?I.blitFramebuffer(Pe,Ve,ge,de,nt,yt,ge,de,I.COLOR_BUFFER_BIT,I.NEAREST):Rn?I.copyTexSubImage3D(vt,le,nt,yt,Ut+Pn,Pe,Ve,ge,de):I.copyTexSubImage2D(vt,le,nt,yt,Pe,Ve,ge,de);Me.bindFramebuffer(I.READ_FRAMEBUFFER,null),Me.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else Rn?T.isDataTexture||T.isData3DTexture?I.texSubImage3D(vt,le,nt,yt,Ut,ge,de,xe,Tt,Fe,Ft.data):F.isCompressedArrayTexture?I.compressedTexSubImage3D(vt,le,nt,yt,Ut,ge,de,xe,Tt,Ft.data):I.texSubImage3D(vt,le,nt,yt,Ut,ge,de,xe,Tt,Fe,Ft):T.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,le,nt,yt,ge,de,Tt,Fe,Ft.data):T.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,le,nt,yt,Ft.width,Ft.height,Tt,Ft.data):I.texSubImage2D(I.TEXTURE_2D,le,nt,yt,ge,de,Tt,Fe,Ft);I.pixelStorei(I.UNPACK_ROW_LENGTH,ht),I.pixelStorei(I.UNPACK_IMAGE_HEIGHT,kn),I.pixelStorei(I.UNPACK_SKIP_PIXELS,ss),I.pixelStorei(I.UNPACK_SKIP_ROWS,Vn),I.pixelStorei(I.UNPACK_SKIP_IMAGES,js),le===0&&F.generateMipmaps&&I.generateMipmap(vt),Me.unbindTexture()},this.initRenderTarget=function(T){v.get(T).__webglFramebuffer===void 0&&U.setupRenderTarget(T)},this.initTexture=function(T){T.isCubeTexture?U.setTextureCube(T,0):T.isData3DTexture?U.setTexture3D(T,0):T.isDataArrayTexture||T.isCompressedArrayTexture?U.setTexture2DArray(T,0):U.setTexture2D(T,0),Me.unbindTexture()},this.resetState=function(){L=0,N=0,B=null,Me.reset(),he.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ci}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=lt._getDrawingBufferColorSpace(e),t.unpackColorSpace=lt._getUnpackColorSpace()}}function kS(){const r=document.createElement("canvas");r.width=64,r.height=64;const e=r.getContext("2d");return e.fillStyle="#FFFFFF",e.beginPath(),e.arc(32,32,32,0,Math.PI*2),e.fill(),r}function VS(){const r=document.querySelector(".hero-section");if(!r)return;const e=new b_;e.background=null;const t=new Yn(75,window.innerWidth/window.innerHeight,.1,1e3);t.position.z=4;const n=document.createElement("canvas"),i=new zS({canvas:n,alpha:!0,antialias:!0,precision:"highp"});i.setSize(window.innerWidth,window.innerHeight),i.setPixelRatio(window.devicePixelRatio),i.setClearColor(0,0),n.style.position="fixed",n.style.top="0",n.style.left="0",n.style.width="100vw",n.style.height="100vh",n.style.zIndex="0",n.style.pointerEvents="none",r.insertBefore(n,r.firstChild);const s=r.querySelector(".container");s&&(s.style.position="relative",s.style.zIndex="10");const o=80,a=[],l=2.5;for(let M=0;M<o;M++){const S={position:new V((Math.random()-.5)*10,(Math.random()-.5)*10,(Math.random()-.5)*8),velocity:new V((Math.random()-.5)*.002,(Math.random()-.5)*.002,(Math.random()-.5)*.001),amplitude:Math.random()*.5+.2,frequency:Math.random()*.003+.001,phase:Math.random()*Math.PI*2,time:0};a.push(S)}const c=new ti,u=new Float32Array(o*3);a.forEach((M,S)=>{u[S*3]=M.position.x,u[S*3+1]=M.position.y,u[S*3+2]=M.position.z}),c.setAttribute("position",new fi(u,3));const h=new Mi({uniforms:{circleTexture:{value:new N_(kS())}},vertexShader:`
      void main() {
        gl_PointSize = 15.0;
        gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      }
